...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ebEnvironment": () => (/* binding */ ebEnvironment)
/* harmony export */ });
var ebEnvironment = {
...
var startDateInit = '2021-07-20';
var startDateEnd = '2021-07-25';
/**  */
var eventSeriesId = '117176613405';
var eventPath = "/v3/series/" + eventSeriesId + "/events?start_date.range_start=" + startDateInit + "&start_date.range_end=" + startDateEnd;
var eventAPI = _Environment_environment__WEBPACK_IMPORTED_MODULE_0__.ebEnvironment.base + eventPath;
var tokenPath = '/Users/sabarishnadarajan/Dev/AOL/token_file.txt';
function processDates(eventData) {
    return ['x', 'y'];
}
function token() {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, new Promise(function (resolve, reject) {
                        fs__WEBPACK_IMPORTED_MODULE_2___default().readFile(tokenPath, function (err, data) {
                            if (err) {
                                reject(err);
                            }
                            resolve(data);
...
function getEventDetails() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_g) {
            switch (_g.label) {
                case 0:
                    _a = node_fetch__WEBPACK_IMPORTED_MODULE_1__.default;
                    _b = [eventAPI];
                    _e = {
                        method: 'GET'
                    };
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _EventBrite_query__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./EventBrite/query */ "./src/EventBrite/query.ts");
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _b = (_a = console).log;
                return [4 /*yield*/, (0,_EventBrite_query__WEBPACK_IMPORTED_MODULE_0__.getEventDetails)()];
            case 1:
                _b.apply(_a, [_c.sent()]);
                return [2 /*return*/];
        }
